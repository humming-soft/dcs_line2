                ...
                if(strtolower($journalType)=='pier'){
                   ...
                   /* if($pid!=NULL && $pid>0){
                    ...
                    if ($this->design->update_check_journal_in($name,$journalid) == 0) {
                     ...
                     $this->design->update_pirer_entry($journalid,$projectno,strtolower($viaductName[0]),$name,$north, $south,$pierType,date('y-m-d'));
                    }
