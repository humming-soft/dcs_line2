...
<div class="container">
	...
	<div class="row">
		<div class="form-group">
			...
			<button type="button" style="margin-right:22px;" class="btn btn-success btn-sm pull-right" id="addbutton"  data-toggle="modal" data-target="#MyModal" <?php if($addperm==0) echo 'disabled="true"'; ?>>Add New</button>
		</div>
	</div>
	<!-- pop-up -->
    ...
    <div>&nbsp;</div>
	<div>
		<table class="table table-striped table-hover" id="non_progressive">
            <thead>
			<tr>
				<th>No</th>
